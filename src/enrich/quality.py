...
def build_quality_report(
    ...
    chunk_preparation_wall_clock_time: float = 0.0,
    total_chunks_expected: int = 0,
    chunks_generated: int = 0,
    chunks_reused: int = 0,
    chunks_skipped: int = 0,
    chunks_regenerated: int = 0,
    chunks_deleted: int = 0,
    chunking_skipped_whisper: bool = False,
) -> dict:
    ...
    return {
        ...
        "chunking_skipped_whisper": chunking_skipped_whisper,
        "chunk_preparation_wall_clock_time": chunk_preparation_wall_clock_time,
        "total_source_audio_duration": total_audio_duration,
